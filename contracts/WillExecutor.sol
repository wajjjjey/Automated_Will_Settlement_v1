...
contract WillExecutor is ERC721URIStorage, Ownable {
    ...
    constructor(
        address _willProtocolAddress
    ) ERC721("PropertyTransferNFT", "PTR") {
        willProtocol = _willProtocolAddress;
        _willProtocol = WillProtocol(_willProtocolAddress);
    }
    ...
    function mintNFTs(
        ...
        require(owner() == msg.sender, "Only WillProtocol can mint NFTs");
