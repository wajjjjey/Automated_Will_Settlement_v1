...
export type { MyToken } from "./contracts/BasicToken.sol/MyToken";
export { MyToken__factory } from "./factories/contracts/BasicToken.sol/MyToken__factory";
export type { Lock } from "./contracts/Lock";
export { Lock__factory } from "./factories/contracts/Lock__factory";
export type { TransferContract } from "./contracts/TransferContract";
export { TransferContract__factory } from "./factories/contracts/TransferContract__factory";
export type { WillExecutor } from "./contracts/WillExecutor";
export { WillExecutor__factory } from "./factories/contracts/WillExecutor__factory";
export type { WillProtocol } from "./contracts/WillProtocol";
export { WillProtocol__factory } from "./factories/contracts/WillProtocol__factory";
